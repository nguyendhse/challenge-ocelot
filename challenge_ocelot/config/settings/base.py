...
# challenge_ocelot/
APPS_DIR = BASE_DIR / "challenge_ocelot"
env = environ.Env()
...
MIGRATION_MODULES = {"sites": "challenge_ocelot.contrib.sites.migrations"}
...
TEMPLATES = [
    {
        ...
        "OPTIONS": {
            ...
            "context_processors": [
                ...
                "challenge_ocelot.users.context_processors.allauth_settings",
            ],
        },
    }
]
...
ADMINS = [("""martin.do""", "martin.do@example.com")]
